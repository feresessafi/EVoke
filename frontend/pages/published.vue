  ...
  <div class="flex h-screen bg-zinc-50 dark:bg-zinc-950">
    ...
    <main class="flex-1 overflow-auto">
      <div class="p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div class="space-y-4">
                ...
                <div v-for="article in publishedArticles.slice(0, 5)" 
                     :key="article.story_title" 
                     class="group flex items-start gap-3 p-3 bg-zinc-100 dark:bg-zinc-900 rounded-lg 
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-2">
                      <h3 class="text-sm font-medium truncate group-hover:text-primary">
                        {{ article.story_title }}
                      </h3>
          ...
          <div class="space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                <div class="space-y-4">
                  <div v-for="topic in topicDistribution.slice(0, 3)" :key="topic.name" 
                       class="space-y-2">
                    <div class="flex items-center justify-between">
                      <div class="space-y-1">
                        ...
                        <div class="flex items-center gap-2 text-xs text-muted-foreground">
                          ...
                          <span>•</span>
                          <span class="text-green-500">+{{ Math.floor(Math.random() * 20) }}% engagement</span>
                        </div>
                      </div>
                    </div>
                    <div class="h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                      <div :class="['h-full', topic.color]"
                ...
                <div class="space-y-4">
                  ...
                  <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                      <span class="text-muted-foreground">Average AI Score</span>
                      <span class="font-medium">74%</span>
                    </div>
                    <div class="h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                      <div :class="['h-full', 'bg-orange-300']"
                           :style="{ width: `74%` }" />
                    </div>
                  ...
                  <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                      <span class="text-muted-foreground">Source Diversity</span>
                  ...
                  <div class="space-y-2">
                    <div class="flex justify-between text-sm">
                      <span class="text-muted-foreground">Readability Score</span>
                      <span class="font-medium">92%</span>
                    </div>
                    <div class="h-2 bg-zinc-100 dark:bg-zinc-800 rounded-full overflow-hidden">
                      <div :class="['h-full', 'bg-orange-700']"
                           :style="{ width: `92%` }" />
                    </div>
                    </div>
                  </div>
        ...
        <div v-if="showAllArticles" class="grid grid-cols-1 lg:grid-cols-2 gap-4">
...
const recommendations = [
  {
    ...
    description: 'Articles about battery innovations show high engagement rates.'
  },
  {
    title: 'Optimize Publishing Schedule',
    description: 'Consider scheduling more posts during peak engagement hours (10:00 AM UTC).'
  },
  {
    title: 'Focus on Technical Content',
    description: 'Technical specifications in EV reviews drive more user interaction.'
  }
];
